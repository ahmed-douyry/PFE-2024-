...
export default function Signup() {
  ...
  const handlepassword_confirmationChange = (e) => setpassword_confirmation(e.target.value);
        ...
        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div className="max-md:text-center">
            ...
            <p className="text-sm mt-6">
              Create an account to enjoy all the benefits of our platform. It's quick and easy!
            </p>
          ...
          <form className="space-y-6 max-w-md md:ml-auto max-md:mx-auto w-full" onSubmit={handleRegister}>
            <h3 className="text-3xl font-extrabold mb-8 max-md:text-center">Sign Up</h3>
